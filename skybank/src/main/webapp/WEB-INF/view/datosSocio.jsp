...
<div class="container mt-3">
  <form:form modelAttribute="socio" cssClass="rounded bg-light p-4" action="/empresa/socios/edit?eId=${socio.empresa.idempresa}" method="post">

  <h1>Tipo de cuenta: <strong style="color: darkred;">Socio</strong></h1>
  <h3>Socio de la empresa: <span style="color: darkred">${socio.empresa.nombre}</span></h3>
